    ...
    public class Navigation
    {
        ...
        public void runControlLoop()
        {
            ...
            while (runThread)
            {
                ...
                y_est = y;
                t_est = t;
                // ENDTEMP: replace with code below:
                /*
        ...
        private void PRMMotionPlanner()
        {
            ...
            double newX, newY; // the randomly-chosen node's x and y coordinates.
            ...
            {
                // pick a random cell from 0 to total occupied cells
                ...
                // Next: check if new expansionNode has a direct line-of-sight connection to the goalNode:
                    if (map.CollisionFound(expansionNode, goalNode, robotRadius) == false)
                    {
                        goalNode.nodeIndex = numNodes;
                        // update index of node chain:
